...
class FestivalListTableViewController: UITableViewController, XMLParserDelegate {

    let listEndPoint = "http://openapi.kepco.co.kr/service/evInfoService/getEvSearchList"
    let ServiceKey = "tEp33kHhaR2SwQPmwWE1r6qwrhUTu1il2PVNGZEGwyvkm8i3MSl6dtzet1Mxofc7tCG1wZTkGjk0W47GM6bxSA%3D%3D"
    let detailEndPoint = "http://openapi.kepco.co.kr/service/evInfoService/getEvSearchList"
    ...
    func getDetail(csId:String){//idx라는 매개변수를 생성
        let str = detailEndPoint + "?serviceKey=\(ServiceKey)&numOfRows=100"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = dic["csNm"]
        cell.detailTextLabel?.text = "\(dic["csId"]!) | \(dic["cpNm"]!)"
